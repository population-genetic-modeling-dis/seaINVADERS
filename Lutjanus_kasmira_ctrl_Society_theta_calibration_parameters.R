...
#source.theta     <- 8.52248   #source population theta mean estimate, use Theta(k) from Arlequin
#source.theta.sd  <- 2.69315   #source population theta stdev estimate, use Theta(k) from Arlequin
source.thetas    <- c(35)  #list of thetas to run, must comment out source.theta and source.theta.sd or this will be ignored
...
min_f_number     <- 49 	#This is the minimum # of colonizing females.
max_f_number     <- 49 	#This is the maximum # of colonizing females.
